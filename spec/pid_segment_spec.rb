...
describe HL7::Message::Segment::PID do
  context 'general' do
    ...
    it 'supports death fields' do
      ...
      expect(pid.patient_id['origin']).to eq ""
      expect(pid.patient_id_list['origin']).to eq "333"
      ...
      expect(pid.address['origin']).to eq ""
      ...
      expect(pid.account_number['origin']).to eq "555.55"
